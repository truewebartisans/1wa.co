...
func main() {
	...
	// Так как мы работаем с React.js, то после
	// сборки, production-версия будет находиться
	// в папке ./build (в корне React-проекта)
...
**Следите за обновлениями, комментируйте и пишите хороший код!**
